    ...
    let result = await fetch(`https://api.nasa.gov/mars-photos/api/v1/rovers/curiosity/photos?earth_date=${date[0]}-${date[1]}-${date[2]}&api_key=${api_key}`)
        ...
        .then(data => {
            ...
            if (data.photos.length > 0) {
                ...
                document.getElementById("error_title").innerText = 'Only default picture available. Please, pick a new date.';
...
function tellusEpic() {
    ...
    xhr.onload = function () {
        if (xhr.response.length == 0) {
            ...
            document.getElementById("image-text").innerText = xhr.response[0].date;
            document.getElementById("image-title").innerText = xhr.response[0].caption;
...
function planeter(planet) {
    ...
    if (planet == 0) {
        document.querySelector(".tell").classList.remove("active");
        document.querySelector(".merc").classList.remove("active");
        document.querySelector(".mars").classList.remove("active");
        document.querySelector(".jupi").classList.remove("active");
        document.querySelector(".satu").classList.remove("active");
        document.querySelector(".uran").classList.remove("active");
        document.querySelector(".nept").classList.remove("active");
        document.querySelector(".venu").classList.add("active");
    ...
    if (planet == 1) {
        document.querySelector(".tell").classList.remove("active");
        document.querySelector(".venu").classList.remove("active");
        document.querySelector(".mars").classList.remove("active");
        document.querySelector(".jupi").classList.remove("active");
        document.querySelector(".satu").classList.remove("active");
        document.querySelector(".uran").classList.remove("active");
        document.querySelector(".nept").classList.remove("active");
        document.querySelector(".merc").classList.add("active");
    ...
    if (planet == 2) {
        ...
        document.querySelector(".uran").classList.remove("active");
        document.querySelector(".nept").classList.remove("active");
        document.querySelector(".jupi").classList.add("active");
    ...
    if (planet == 3) {
        ...
        document.querySelector(".uran").classList.remove("active");
        document.querySelector(".nept").classList.remove("active");
        document.querySelector(".satu").classList.add("active");
    ...
    if (planet == 4) {
        ...
        document.querySelector(".merc").classList.remove("active");
        document.querySelector(".nept").classList.remove("active");
        document.querySelector(".uran").classList.add("active");
    ...
    if (planet == 5) {
        ...
        document.querySelector(".uran").classList.remove("active");
        document.querySelector(".merc").classList.remove("active");
        document.querySelector(".nept").classList.add("active");
    ...
    if (planet == 6) {
        ...
        document.querySelector(".uran").classList.remove("active");
        document.querySelector(".nept").classList.remove("active");
        document.querySelector(".tell").classList.add("active");
